...
print("I am going to ask you a few questions. You must press Enter after each response.")
userName = input("\nEnter your name:  ")

while len(userName) == 0:
   userName = input("Name cannot be blank! Please enter your name: ")
   
if userName.lower()== "lenora welborne": 
...
while keepGoing.lower() == "y":
    ...
    while method not in ["carryout", "delivery"]:
        method = input("Invalid value! Please enter carryout or delivery: ")   
